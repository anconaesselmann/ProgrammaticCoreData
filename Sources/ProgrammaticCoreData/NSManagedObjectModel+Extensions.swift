...
public extension NSManagedObjectModel {
    ...
    func createCloudContainer(name: String, cloudContainerIdentifier: String) throws -> NSPersistentContainer {
        try NSPersistentCloudKitContainer(name: name, managedObjectModel: self, cloudContainerIdentifier: cloudContainerIdentifier)
    }
